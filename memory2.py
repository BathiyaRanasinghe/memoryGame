...
#
# Version 2 
# The second version must add the score. It must also start with all the tiles hidden by
# displaying image0.bmp for each tile. When the player clicks on a tile, the tile should 
# become permanently exposed. The game should end (the score should stop changing) when all 
# 16 tiles have been exposed (in any order).
